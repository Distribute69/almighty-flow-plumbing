    ...
    >
      <div className="mx-auto flex h-[4.5rem] max-w-7xl items-center justify-between gap-4 px-5 sm:h-20 sm:px-8">
        ...
        <div className="relative z-10 flex items-center gap-2 sm:gap-3">
          <a
            href={`tel:${site.phoneHref}`}
            className="hidden items-center gap-2 rounded-full border border-accent/20 bg-accent/5 px-3 py-2 text-sm font-bold text-accent-bright transition-colors hover:border-accent/50 lg:flex"
          >
            <PhoneIcon />
            {site.phone}
          </a>
